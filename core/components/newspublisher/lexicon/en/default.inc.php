...
$_lang['np_publish_permission_denied'] = 'The document should be published, but you do not have permission to save a document.';
...
$_lang['np_submit'] = 'Submit';
$_lang['np_cancel'] = 'Cancel';
$_lang['np_delete'] = 'Delete';
$_lang['np_error_occured'] = 'An error occured: ';
